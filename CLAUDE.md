# Agent contract — Autotelic goal generation: generator + independent Goldilocks critic

This repository is a concept project (`C-006`, archetype `implementation`).
...
- **One question.** A second interesting idea goes to the Linear backlog (`sota-concept`
  issues), not into this repository.
